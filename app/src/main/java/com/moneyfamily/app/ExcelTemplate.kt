...
${row(9,listOf("Importazione","Non modificare i nomi delle colonne. Tutti i 6 campi sono obbligatori per ogni riga."))}
${row(10,listOf("Tipologia e Categoria","Se una tipologia è associata a una categoria nell'app, usa la categoria associata. Il valore deve comunque essere presente nel file."))}
${row(11,listOf("Controlli","Dopo l'importazione le operazioni vengono salvate nel database e il dashboard viene aggiornato automaticamente."))}
</sheetData></worksheet>"""
